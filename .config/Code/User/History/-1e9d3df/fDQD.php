    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($daya !== null && $kwh_lalu !== null && $kwh_sekarang !== null && $materai !== null) {
                ...
                switch ($data) {
                    case 450:
                        $biayaBeban = $batasDaya / 1000 * $nilaiAwal;

                        $pemakaianBlokSatu = $blogSatu * $tarifBlokSatu;
                        $pemakaianBlokDua = $blogDua * $tarifBlokDua;
                        $pemakaianBlokTiga = $blogTiga * $tarifBlokTiga;

                        $totalPemakaian = $pemakaianBlokSatu + $pemakaianBlokDua + $pemakaianBlokTiga * 0.1;

                        echo "TOTAL" . $totalPemakaian;
                        break;
                    case 900:
                        $biayaBeban = $batasDaya / 1000 * $nilaiKedua;
