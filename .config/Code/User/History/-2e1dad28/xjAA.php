<section class="output">
    ...
    <footer class="grades">
        ...
        <div class="nilai-ket">
            ...
            <h2 class="value-grade"> <?= $calculateGrade($type::NILAI_KOG, $_POST["matkul"], $_POST["tugas-kogtinif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"]) ?> </h2>
        </div>
