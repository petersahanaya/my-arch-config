    ...
    <footer class="grades">
        <div class="nilai-kog">
            ...
            <h2 class="value-grade">
                <?php
                echo $calculateGrade(Type::NILAI_KOG, $_POST["tugas-kogninif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"])
                ?>
            </h2>
        </div>
        <div class="nilai-ket">
            ...
            <h2 class="value-grade">
                <?php echo $calculateGrade(Type::NILAI_KET, $_POST["tugas-kogninif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"]) ?>
            </h2>
        </div>
        ...
        <div class="grade">
            ...
            <h2 class="value-grade">
                <?php echo $calculateGrade(Type::NILAI_AKHIR, $_POST["matkul"], $_POST["tugas-kogtinif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"]) ?>
            </h2>
        </div>
    </footer>
</section>