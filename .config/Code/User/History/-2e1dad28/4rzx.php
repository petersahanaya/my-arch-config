...
<section class="output">
    ...
    <footer class="grades">
        ...
        <div class="grade">
            ...
            <h2 class="value-grade">
                <?php echo $calculateGrade(Type::NILAI_AKHIR, $_POST["tugas-kogninif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"]) ?>
            </h2>
        </div>
    </footer>
</section>