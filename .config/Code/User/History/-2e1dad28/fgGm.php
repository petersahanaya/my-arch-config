<section class="output">
    ...
    <footer class="grades">
        <div class="nilai-kog">
            ...
            <h2 class="value-grade"> </h2>
        </div>
        <div class="nilai-ket">
            <h2>Skill Score</h2>

            <h2 class="value-grade"> <?= $calculateGrade($type::NILAI_KET, $_POST["matkul"], $_POST["tugas-kogtinif"], $_POST["tugas-keterampilan"], $_POST["ulangan-kognitif"], $_POST["ulangan-keterampilan"], $_POST["uts"], $_POST["uas"]) ?> </h2>
        </div>
